...
int main(int argc, char const *argv[]) {
    ...
    SimpleVector<int> v6;
    SimpleVector<int> v7;
    vector<int> v8; // transform 도착지 용도
    ...
    cout << distance(v1.begin(), v1.end()) << endl;
    cout << distance(next(v1.begin()), prev(v1.end())) << endl;

    auto begin = v1.begin();
    advance(begin, 1);

    cout << distance(begin, v1.end()) << endl;
